  ...
  return (
    <Card className="w-full shadow-lg border-0 bg-white/90 backdrop-blur-sm">
      <CardHeader className="space-y-1 text-center">
        ...
        <CardTitle className="text-2xl font-bold text-amber-900">Daftar</CardTitle>
        <CardDescription className="text-amber-700">Buat akun baru untuk memulai</CardDescription>
      </CardHeader>
